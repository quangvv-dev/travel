                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <ul class="nav nav-tabs">
                            <li class="upload-files active"><a data-toggle="tab"
                                                               href="#home"><?php echo __('form.upload_files') ?></a>
                            </li>
                            <li class="library-img"><a data-toggle="tab"
                                                       href="#library"><?php echo __('form.media_library') ?></a></li>
                        </ul>
                            ...
                            <div id="home" class="tab-pane fade in active" style="width: 100%;">
                                ...
                                <div class="modal-h">
                                    <button type="button" class="btn btn-primary" data-dismiss="modal"
                                            id="cancel_model"><?php echo __('form.start_upload') ?></button>
                                </div>
                            </div>
                            <div id="library" class="tab-pane fade" style="height: 540px;">
                                <div class="wrap-loading-icon show_img">
                                    <div class="lds-dual-ring"></div>
                                </div>
                                <input type="text" placeholder="<?php echo __('form_search_images_by_name') ?>"
                                       class="search_images">
                                <div class="wrap-library" style="overflow-y: scroll;max-height: 500px;">
                                    ...
                                    if (count($images) > 0) {
                                        foreach ($images as $item) {
                                            ?>
                                            <div data-title='<?php echo $item->title ?>'
                                                 data-alt='<?php echo $item->alt ?>' data-id="<?php echo $item->id; ?>"
                                                 data-src="<?php
                                                 echo asset('uploads') . '/' . $item->path . '/' . $item->name
                                                 ?>"
                                                 class='image-item' style="position: relative;">
                                ...
                                <div class="modal-f">
                                    <button type="button" disabled="disabled" class="btn btn-primary"
                                            data-dismiss="modal"
                                            id="inset_image"><?php echo __('form.insert_into_page') ?></button>
                                </div>
                            </div>
